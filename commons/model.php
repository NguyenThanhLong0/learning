...
//listAll chung lấy thay tên bảng '',..
...
if (!function_exists('listAll')) {
    function listAll($tableName)
    {
        try {
            ...
            debug($e); // nếu có lỗi báo lỗi ra luôn
        }
    }
}
//listAll chung lấy thay tên bảng '',..
if (!function_exists('showOne')) {
    ...
    {
        try {
            $sql = "SELECT * FROM $tableName WHERE id = :id LIMIT 1"; // lấy 1
...
if (!function_exists('update')) {
    function update($tableName, $id, $data = [])
    {
        try {
            ...
            $stmt->bindParam(":id", $id); //id riêng vì ko nằm trong where
...
if (!function_exists('delete2')) {
    function delete2($tableName, $id)
    {
        try {
            ...
            $stmt->bindParam(":id", $id); // nếu có lỗi báo lỗi ra luôn
